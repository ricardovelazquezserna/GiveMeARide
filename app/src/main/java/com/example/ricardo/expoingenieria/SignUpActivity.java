...
public class SignUpActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private EditText nameView,lastnameView,mPasswordView,confirmPasswordView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameView = (EditText) findViewById(R.id.firstname_signup);
        lastnameView = (EditText) findViewById(R.id.lastname_signup);
        confirmPasswordView = (EditText) findViewById(R.id.repassword_signup);
    ...
    private void attemptSignup() {
        ...
        if (!TextUtils.isEmpty(password) && !isPasswordValid(password) && isPasswordSame(confirmpass,password)) {
    ...
    private boolean isPasswordSame(String confirmpass,String password) {
        //TODO: Replace this with your own logic
